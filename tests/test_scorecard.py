...
claim is "no tunable inputs at any layer".  This test suite makes that
...
# ═══════════════════════════════════════════════════════════════════════
#  Structural closure  (E8 mode accounting, no tunable inputs)
# ═══════════════════════════════════════════════════════════════════════
...
def test_strong_cp_resolved(res):
    ...
    for key, val in res["alg"].items():
        assert "theta_QCD" not in key.lower(), (
            "theta_QCD appeared as a derived/tunable input - "
