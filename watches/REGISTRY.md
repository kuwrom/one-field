...
| 3 | m_s/m_ud ratio | `m_s/m_ud = 27.130` (RG-invariant, no coordinate) | lattice average tightening at 27.30(8) and staying | FLAG-class lattice ratio | 2026-06 |
| 4 | sin²θ_W emission weight | `sin²θ_W(M_Z) = 3/13 + h₇·(α/2π) = 0.231234` (weight h₇ = 2/5) | the 5/13 weight (0.231216) or any other family weight | FCC-ee Z-pole (σ ~ 9 × 10⁻⁶) | 2026-06 |
